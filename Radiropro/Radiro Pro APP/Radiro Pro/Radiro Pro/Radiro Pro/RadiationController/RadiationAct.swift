...
class RadiationAct : UIViewController {
    ...
    override func viewDidLoad() {
        ...
        navigationItem.title = "Radiation-Activity"
    ...
    @IBAction func detailsbtn(_ sender: Any) {
        ...
        let nextvc = storyboard?.instantiateViewController(withIdentifier: "Radiationactdetail")
